...
const char *const CLIENT_BUS_NAME = "com.mohit.client";
const char *const SERVER_OBJECT_PATH_NAME = "/home/shared/Dbus";
const char *const CLIENT_OBJECT_PATH_NAME = "/home/shared/Dbus_client";
...
int main (int argc, char **argv)
{
    DBusConnection *conn;
    int ret;
    char input [80]="whoopsie service";
...
//  fp = popen("bin/grep ");
  ...
  /* Open the command for reading. */
    ...
    {
      printf("service is running, no action needed, terminating process \n");
      pclose(fp);
      return 0;
      break;
    }
    ...
    dones:
       ...
       usleep(20);
        ...
        printf("Service now started, exiting");
